export const modalData = {
  'data': [{
    ...
    'id': '2', 'type': 'anime', 'links': {'self': 'https://kitsu.io/api/edge/anime/2'}, 'attributes': {
      ...
      'synopsis': 'An0their ind.\n[Written by MAL Rewrite]',
      'description': 'rdd have realized.\n[Written by MAL Rewrite]',
    ...
    'id': '3', 'type': 'anime', 'links': {'self': 'https://kitsu.io/api/edge/anime/3'}, 'attributes': {
      ...
      'slug': 'trigun',
      'synopsis': 'Vash thde is ,000 bounty on\n[Written by MAL Rewrite]',
      'description': 'Vash the Stampede is the man with',
      'coverImageTopOffset': 100,
      'titles': {'en': 'Trigun', 'en_jp': 'Trigun', 'ja_jp': 'トライガン'},
      ...
      'tba': '',
      'posterImage': {
        'tiny': 'https://media.kitsu.io/anime/poster_images/3/tiny.jpg',
        'large': 'https://media.kitsu.io/anime/poster_images/3/large.jpg',
        'small': 'https://media.kitsu.io/anime/poster_images/3/small.jpg',
        'medium': 'https://media.kitsu.io/anime/poster_images/3/medium.jpg',
        'original': 'https://media.kitsu.io/anime/poster_images/3/original.jpg',
        'meta': {
          'dimensions': {
            'tiny': {'width': 110, 'height': 156},
            'large': {'width': 550, 'height': 780},
    ...
    'id': '4', 'type': 'anime', 'links': {'self': 'https://kitsu.io/api/edge/anime/4'}, 'attributes': {
      ...
      'synopsis': 'Witches areSPhe first place.\n(Source: ANN)',
      'description': 'Witsis place.\n(Source: ANN)',
      'coverImageTopOffset': 230,
      'titles': {'en': 'Witch Hunter Robin'},
  ...
  },
  {
    'id': '5', 'type': 'anime', 'links': {'self': 'https://kitsu.io/api/edge/anime/5'}, 'attributes': {
      ...
      'synopsis': 'It is rk cene rule of the devil, Vandelcentury. ',
      'description': 'It is the dark century and the peop rule of the devil, ',
      'coverImageTopOffset': 0,
      'titles': {'en': 'Beet the Vandel Buster', 'ja_jp': '冒険王ビィト'},
